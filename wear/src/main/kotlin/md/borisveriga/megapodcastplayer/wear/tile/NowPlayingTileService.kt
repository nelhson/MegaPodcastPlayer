...
import md.borisveriga.megapodcastplayer.wear.ui.showAccentArgb
...
class NowPlayingTileService : TileService() {
     ...
     * [md.borisveriga.megapodcastplayer.wear.ongoing.NowPlayingChipService] turns into a tile update — so the
