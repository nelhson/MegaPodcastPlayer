...
/** The coroutine dispatchers MegaPodcastPlayer injects, so tests can swap in a test dispatcher. */
enum class MegaPodcastPlayerDispatcher {
...
annotation class Dispatcher(val dispatcher: MegaPodcastPlayerDispatcher)
