...
class ControlsTest {
    ...
    fun `play button announces play when paused`() {
        composeTestRule.setContent {
            BPodcatTheme { PlayPauseButton(playing = false, onToggle = {}) }
        }
    ...
    fun `play button announces pause when playing`() {
        composeTestRule.setContent {
            BPodcatTheme { PlayPauseButton(playing = true, onToggle = {}) }
        }
    ...
    fun `play button reports the requested state`() {
        ...
        composeTestRule.setContent {
            BPodcatTheme { PlayPauseButton(playing = false, onToggle = { requested = it }) }
        }
