 ...
 *
 * Read these through [MegaPodcastPlayerTheme.colors], never by importing the values directly: the two
 ...
 */
@Immutable
data class MegaPodcastPlayerColors(
 ...
 */
internal val citronLightExtendedColors = MegaPodcastPlayerColors(
...
/** Dark bindings. */
internal val citronDarkExtendedColors = MegaPodcastPlayerColors(
