...
fun SelectionToolbar(
    ...
    AnimatedVisibility(
        ...
        Surface(
            shape = MegaPodcastPlayerTheme.shapes.pill,
            color = MaterialTheme.colorScheme.inverseSurface,
            contentColor = MaterialTheme.colorScheme.inverseOnSurface,
            tonalElevation = MegaPodcastPlayerTheme.elevation.level3,
            shadowElevation = MegaPodcastPlayerTheme.elevation.level3,
        ) {
            Row(
                modifier = Modifier.padding(
                    start = MegaPodcastPlayerTheme.spacing.lg,
                    end = MegaPodcastPlayerTheme.spacing.sm,
                    top = MegaPodcastPlayerTheme.spacing.xs,
                    bottom = MegaPodcastPlayerTheme.spacing.xs,
                ),
