package md.borisveriga.megapodcastplayer.core.designsystem.shape
 ...
 *
 * Every polygon in [MegaPodcastPlayerPolygons] is authored in a `-1..1` box centred on the origin, which is
 ...
 * does.
 */
object MegaPodcastPlayerPolygons {
