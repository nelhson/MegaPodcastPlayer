...
/**
 * MegaPodcastPlayer's type system: Bricolage Grotesque for anything that announces, Inter for anything
 * that is read.
 *
...
/**
 * The Material 3 type scale, restated in MegaPodcastPlayer's faces.
 *
 ...
 */
internal val megaPodcastPlayerTypography = Typography(
 ...
 */
@Immutable
data class MegaPodcastPlayerTypeExtras(
    val numeric: TextStyle,
    val numericLarge: TextStyle,
)

internal val megaPodcastPlayerTypeExtras = MegaPodcastPlayerTypeExtras(
    numeric = TextStyle(
        fontFamily = interFamily,
