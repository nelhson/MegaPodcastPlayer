 ...
 *
 * Collapses into [BPodcatTopAppBar]'s proportions as the list under it scrolls: expanded, Material
...
@Preview
@Composable
private fun BPodcatTopAppBarPreview() {
    BPodcatTheme {
        BPodcatTopAppBar(title = "Settings", onBack = {})
    }
}
...
@Preview
@Composable
private fun BPodcatLargeTopAppBarPreview() {
    BPodcatTheme {
