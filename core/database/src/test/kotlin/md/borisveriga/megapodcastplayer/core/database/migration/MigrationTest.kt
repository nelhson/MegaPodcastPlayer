...
class MigrationTest {
    ...
    fun `migrates a v1 library without losing data`() = runTest {
        ...
        val database = Room.databaseBuilder(context, MegaPodcastPlayerDatabase::class.java, DB_NAME)
    ...
    private companion object {
        ...
        val VERSION_2_EPISODES = listOf(
            "episode-file" to "file:///data/data/md.borisveriga.megapodcastplayer/databases/megapodcastplayer.db",
