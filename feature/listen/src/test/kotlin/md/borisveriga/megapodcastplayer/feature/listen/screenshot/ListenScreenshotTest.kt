package md.borisveriga.megapodcastplayer.feature.listen.screenshot
...
import md.borisveriga.megapodcastplayer.feature.listen.ListenScreenEmptyPreview
import md.borisveriga.megapodcastplayer.feature.listen.ListenScreenPreview
...
/**
 * Goldens for the Listen tab, the app’s start destination.
 *
...
class ListenScreenshotTest(private val variant: ScreenshotVariant) {
    ...
    @Test
    fun listen() = capture("listen") { ListenScreenPreview() }

    @Test
    fun listenEmpty() = capture("listen-empty") { ListenScreenEmptyPreview() }
