package md.borisveriga.megapodcastplayer.feature.library.screenshot
...
/**
 * Goldens for the library, in both of its layouts.
 *
...
class LibraryScreenshotTest(private val variant: ScreenshotVariant) {
    ...
    @Test
    fun libraryGrid() = capture("library-grid") { LibraryScreenPreview() }
