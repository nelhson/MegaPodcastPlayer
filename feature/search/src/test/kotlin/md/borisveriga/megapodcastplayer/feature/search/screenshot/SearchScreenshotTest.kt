package md.borisveriga.megapodcastplayer.feature.search.screenshot
...
import md.borisveriga.megapodcastplayer.feature.search.SearchScreenLinkPreview
import md.borisveriga.megapodcastplayer.feature.search.SearchScreenPreview
...
/**
 * Goldens for the add-a-show screen.
 *
...
class SearchScreenshotTest(private val variant: ScreenshotVariant) {
    ...
    @Test
    fun search() = capture("search") { SearchScreenPreview() }

    @Test
    fun searchLink() = capture("search-link") { SearchScreenLinkPreview() }
