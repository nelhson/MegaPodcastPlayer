package md.borisveriga.megapodcastplayer.feature.moments.screenshot
...
/**
 * Goldens for the moments screen.
 *
...
class MomentsScreenshotTest(private val variant: ScreenshotVariant) {
