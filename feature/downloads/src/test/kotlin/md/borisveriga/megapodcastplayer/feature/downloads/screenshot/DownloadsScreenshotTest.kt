package md.borisveriga.megapodcastplayer.feature.downloads.screenshot
...
/**
 * Goldens for the downloads screen.
 *
...
class DownloadsScreenshotTest(private val variant: ScreenshotVariant) {
